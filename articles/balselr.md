...
This is an example which shows how to parse an R object made from a vcf
file and output an input file for `ncd1`:
...
Run `ncd1` with a 3000 basepair window and a minimum of 8 informative
sites per window using 2 cores and a target frequency of 0.5:
...
This is an example which shows how to parse an R object made from a vcf
file and output an input file for `ncd1`; use only one individual for
the outgroup:
...
Run `ncd2` with a 3000 basepair window and a minimum of 8 informative
sites per window using 2 cores and a target frequency of 0.5:
